...
<?php                                                           
                                                                ...
                                                                $fetchqry2 = "UPDATE `ans` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `ans` where id='$c'"; 
                $result=mysqli_query($con,$fetchqry);
                $num=mysqli_num_rows($result);
                $row = mysqli_fetch_array($result,MYSQLI_ASSOC); }
          ?>
<tr><td><h3><br><?php echo @$row['ques'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 6){ ?>
 ...
 <?php if($_SESSION['clicks']>5){ 
    $qry3 = "SELECT `ans`, `userans` FROM `ans`;";
